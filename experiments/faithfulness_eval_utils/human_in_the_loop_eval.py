...
class FaithfulnessEvaluator:
    ...
    def _build_ui(self) -> None:
        ...
        # Set a modern, readable default font (Arial 12)
        ...
        # Make evidence field larger and use Arial font
        self.evidence_txt = tk.Text(
            text_frame,
            height=15,
            wrap="word",
    ...
    def _finish(self) -> None:
        ...
        # write detailed results
        with open(
            os.path.join(self.result_dir, self.results_filename),
            "w",
            encoding="utf-8"
        ) as f:
            json.dump(self.samples, f, indent=2, ensure_ascii=False)
        ...
        stats = {
            ...
            "distribution": {str(i): valid_scores.count(i)
                for i in range(1, 6)},
        }
        with open(
            os.path.join(self.result_dir, self.stats_filename),
            "w",
            encoding="utf-8"
        ) as f:
            json.dump(stats, f, indent=2, ensure_ascii=False)
